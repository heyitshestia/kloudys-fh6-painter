...
```sh
python tools/fabric-editor/locales/manage.py sync
```
...
```sh
python tools/fabric-editor/locales/manage.py build
python tools/fabric-editor/locales/manage.py check
node tools/fabric-editor/tests/editor-i18n.node.js
python tools/fabric-editor/tests/editor-localization.test.py
python tools/fabric-editor/tests/editor-localization-native.py
node tools/fabric-editor/tests/editor-core.node.js
node tools/fabric-editor/tests/editor-preferences.node.js
