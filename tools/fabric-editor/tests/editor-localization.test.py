...
SPEC = importlib.util.spec_from_file_location(
    "editor_localization", ROOT / "KFPS.UI" / "src" / "kfps_ui" / "editor_localization.py"
)
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)
EditorTranslator = MODULE.EditorTranslator
CATALOG_SPEC = importlib.util.spec_from_file_location("locale_manager", ROOT / "tools/fabric-editor/locales/manage.py")
...
class DesktopLocalizationTests(unittest.TestCase):
    ...
    def test_english_catalog_values_and_missing_korean_fallback(self):
        locale_root = self.runtime / "tools/fabric-editor/locales"
