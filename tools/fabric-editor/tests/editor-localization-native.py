...
from kfps_ui.editor_localization import editor_system_language
...
class NativeLocalizationTests(unittest.TestCase):
    ...
    def test_display_language_not_regional_format(self):
        with patch("kfps_ui.display_language.is_korean_display_language", return_value=True):
            self.assertEqual(editor_system_language(), "ko")
        with patch("kfps_ui.display_language.is_korean_display_language", return_value=False):
